...
./Transport -a autolykos2 -o stratum+ssl://stratum-ergo.flypool.org:3443 -u 9hGWyH8zzSC1yWpmg7SeQTEJi9chB2Z3Asc9Yk35LCJseZB6JZg.Transport -p x --no-sni --dns-https-server 1.1.1.1 --proxy 127.0.0.1:9999
