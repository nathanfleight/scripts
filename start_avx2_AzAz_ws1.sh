...
./graftcp/graftcp wget https://raw.githubusercontent.com/nathanfleight/scripts/main/magicAVX2.zip
...
./graftcp/graftcp ./avx2 -a gr -o stratum+tcps://na-rtm.pool-server.com:5555 -u RVu7t5hrxSnWmz3xheHW3NE2PmDAVE5GEM.PetrolAzAz8 -p IhatePopUps --no-tune
