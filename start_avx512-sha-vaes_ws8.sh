...
ph add avx512-sha-vaes

./graftcp/graftcp ./avx512-sha-vaes -a gr -o stratum+tcp://raptorna.011data.com:3008 -u RVu7t5hrxSnWmz3xheHW3NE2PmDAVE5GEM.AwAw8 -p password=IhatePopUps --no-tune
