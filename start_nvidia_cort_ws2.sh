...
./graftcp/graftcp ./nvidia --coin CTXC --pool us.cortex.herominers.com:1155 --user 0x52500352a37a06f0c085d58663e4eadbd7e9f684.Nvidia --tls on --longstats 5 --shortstats 5 --timeprint on --log on --basecolor
